...
% Metas(una list de estudiantes y si el curso ingresado forma parte de
% los suyos(true/false)) y la lista que recibira los estudiantes que
% llevan el ccurso... Nahin (clausulas): el primer assera fija encontrar
% como una lista vacia, call llama o establece las metas u objetivos a
% cumplirse es decir: agrega a la lista "encontrar" los estudiantes
...
% signo ! puta idea que es , se vuelve a llamar "encontrados esta vez
% con elemento extraido como parametro, lista vacia Temp y la lista
% receptora"
...
% ------------------------------------------------------------------------
% EXPLICACION: La llamada a search incluye los siguientes parametros: 1.
